SELECT
	...
	3.41214*A.existing_kwh/E.sum_sqft as existing_EUI_kbtu_over_sqft -- 1 kwh = 3.41214 kbtu
...
WHERE
	...
	A.total_savings_per_year/A.net_replacement_cost > 0.2 AND
	E.count_areas_sqft_null = 0
ORDER By
	B.project_id,
	C.proposal_id,
	A.option_id,
